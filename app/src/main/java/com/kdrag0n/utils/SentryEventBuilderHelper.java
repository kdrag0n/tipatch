...
import com.kdrag0n.tipatch.BuildConfig;
 ...
 */
public class SentryEventBuilderHelper implements EventBuilderHelper {

    /**
     * Logger tag.
     */
    private static final String TAG = SentryEventBuilderHelper.class.getName();
     ...
     */
    public SentryEventBuilderHelper(Context ctx) {
        this.ctx = ctx;
    }
    ...
    public void helpBuildingEvent(EventBuilder eventBuilder) {
        ...
        eventBuilder.withDist(Integer.toString(BuildConfig.VERSION_CODE));
    ...
    private Map<String, Map<String, Object>> getContexts() {
        ...
        deviceMap.put("arch",                  Build.SUPPORTED_ABIS[0]);
        ...
        appMap.put("app_identifier", BuildConfig.APPLICATION_ID);
